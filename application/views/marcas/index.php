        ...
        <div class="content mt-3">
            <div class="card">
                <div class="card-header">
                    ...
                    <a title="Cadastrar novo marca" href="<?php echo base_url('marcas/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Nova marca</a>
                </div>
