                        ...
                        <fieldset class="border p-2" style="margin-top: -10px;">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" name="produto_codigo" class="form-control form-control-user bg-light" id="produto_codigo" value="<?php echo $produto_codigo; ?>" readonly="">
                                </div>
                        ...
                        <fieldset class="mt-2 border p-2">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" name="produto_unidade" class="form-control form-control-user" id="produto_unidade" placeholder="Unidade, Kilo, Grama, etc..." value="<?php echo set_value('produto_unidade'); ?>">
